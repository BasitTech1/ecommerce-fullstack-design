...
const ProductSiderBar = () => {
  ...
  return (
    <div className='flex items-start ml-14 gap-2 justify-start flex-col w-[10%]'>
      <hr className='text-gray-300 w-35 h-0.5' />
      <div>
        <h2 onClick={expandCategory} className='flex items-center gap-12 text-[18px] font-medium text-gray-900'>
          Category
          <img className={`cursor-pointer ${showCategory ? 'rotate-180 transition-all' : ''}`} src={assets.arrowIcon} alt="" />
        </h2>
        <div className={`transition-all duration-300 overflow-hidden ${showCategory ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
          <ul className='flex flex-col gap-2 text-gray-500 text-[15px] cursor-pointer'>
      ...
      <hr className='text-gray-300 w-35 h-0.5' />
      <div>
        <h2 onClick={expandBrand} className='flex items-center gap-17 text-[18px] font-medium text-gray-900 cursor-pointer'>
          Brands
      ...
      <hr className='text-gray-300 w-35 h-0.5' />
      <div>
        <h2 onClick={expandFeature} className='flex items-center gap-14 text-[18px] font-medium text-gray-900 cursor-pointer'>
          Features
      ...
      <hr className='text-gray-300 w-35 h-0.5' />
      <div>
        <h2 onClick={expandPrice} className='flex items-center gap-21 text-[18px] font-medium text-gray-900 cursor-pointer'>
          Price
          <img className={`${showPrice ? 'rotate-180' : ''}`} src={assets.arrowIcon} alt="" />
        </h2>
      ...
      <hr className='text-gray-300 w-35 h-0.5' />
      <div>
        <h2 onClick={expanCondition} className='flex items-center gap-12 text-[18px] font-medium text-gray-900 cursor-pointer'>
          Condition
